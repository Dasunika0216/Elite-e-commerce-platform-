...
const Add = ({token}) => {
  ...
  return (
    <form className='flex flex-col w-full gap-3 items-start' onSubmit={onSubmitHandler}>
      <div>
      ...
      <div className='w-full'>
        ...
        <input type="text" className='w-full max-w-[500px] px-3 py-2' placeholder='Type Here' required onChange={(e) => setName(e.target.value)} value={name}/>
      </div>

      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea type="text" className='w-full max-w-[500px] px-3 py-2' placeholder='Write Content Here' required onChange={(e) => setDescription(e.target.value)} value={description}/>
      </div>
